...
$(document).ready(function () {
  ...
  if ($(".services-page-content__item").length > 0) {
    var tab_btn = $(".services-page .ui-tabs__label"),
  ...
  if ($(".list-series-content__item").length > 0) {
    var _tab_btn = $(".list-series .ui-tabs__label"),
        _tab_content = $(".list-series-content__item");

    _tab_btn.click(function () {
      var i = $(this).index();

      _tab_content.removeClass("list-series-content__item_active");

      _tab_content.eq(i).addClass("list-series-content__item_active");
    });
  ...
  var form_tel = $('.services-page-form__phone'),
  ...
  var pagination__btn = $(".pagination__btn");
  ...
  if ($(".user-list-product__item").length > 0) {
    var _tab_btn2 = $(".user-catalog .ui-tabs__label"),
        _tab_content2 = $(".user-list-product__item"),
        tab_btn_active = $(".user-catalog .ui-tabs__input:checked").index();

    _tab_content2.hide();

    _tab_content2.eq(tab_btn_active).show();
  ...
  if ($(window).width() <= 1200) {
    var _user_nav_mobile_btn = $('#user-nav-btn-mobile'),
        _user_nav_mobile = $('.user-nav-mobile .user-nav'),
        user_nav_item = $('.user-nav__item'),
        nav_mobile_btn = $('#nav-btn-mobile'),
        nav_mobile = $('.nav-mobile .nav__list');

    user_nav_item.click(function (e) {
      _user_nav_mobile_btn.toggleClass("active");

      _user_nav_mobile.toggleClass('user-nav_active');
    });
    nav_mobile_btn.click(function (e) {
      ...
      _user_nav_mobile_btn.removeClass("active");

      _user_nav_mobile.removeClass('user-nav_active');
    ...
    _user_nav_mobile_btn.click(function (e) {
      e.preventDefault();
